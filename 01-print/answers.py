...
print("22 ni 4 bo'lsak", 22/4, "chiqadi")

# Tomonlari 125 ga teng kvadratning yuzi va perimetrini toping
print("Tomonlari 125 ga teng kvadratning yuzi", 125*125, "ga", "perimetri", 4*125, "ga teng")

# Diametri 12 ga teng bo'lgan doiraning yuzini toping (п=3.14)
...
print("Katetlari 6 va 7 bo'lgan to'g'ri burchakli uchburchakning gipotenuzasi",\
      (6**2+7**2)**(1/2), "ga teng")